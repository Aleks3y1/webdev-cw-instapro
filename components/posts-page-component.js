...
import {dataFormat, userLike, saveCodeOnError} from "../helpers.js";
...
const renderUserPosts = (posts) => {
    ...
    <div class="post-likes">
      <button data-post-id="${comment.id}" data-index="${index}" class="like-button">
        ${comment.isLiked ? '<img src="./assets/images/like-active.svg" alt="картинка лайка">' : '<img src="./assets/images/like-not-active.svg" alt="картинка лайка">'}
      </button>
    ...
    <p class="post-text">
      ...
      ${saveCodeOnError(comment.description)}
    </p>
    <p class="post-date">
        ...
        .map((comment, index) => {
            return `
                ...
                comment.user.name
                    ...
                    <div class="post-likes">
                      <button data-post-id="${comment.id}" data-index="${index}" class="like-button">
                        ${comment.isLiked ? '<img src="./assets/images/like-active.svg" alt="картинка лайка">' : 
